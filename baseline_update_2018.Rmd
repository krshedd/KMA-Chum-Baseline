...
```{r fst_mds_all}
MDS.f<-function(dist,popvec,colvec,main,labels=F,locNames=F,axes=F,box=T,adj=c(2,2),cex=.7,size=1.3){
...
MDS.f(dist = pairwise_fst, popvec = 1:63, colvec = match(colors_7[groupvec_7], colors()), main = "", labels = TRUE, locNames = 1:63, axes = TRUE, box = TRUE, adj = c(1.5, 1.5), cex = 1, size = 1.3)
dir.create("../2018/MDS")
# rgl.postscript("../2018/MDS/all_populations_63_fst.pdf", fmt = "pdf", drawText = TRUE)
rgl.snapshot("../2018/MDS/all_populations_63_fst.png", fmt = "png")
```
...
```{r fst_mds_kodiak, message=FALSE, warning=FALSE, fig.width=11.5, fig.height=10}
# MDS.f(dist = pairwise_fst, popvec = 32:63, colvec = match(colors_7[groupvec_7], colors()), main = "", labels = TRUE, locNames = 1:63, axes = TRUE, box = TRUE, adj = c(1.5, 1.5), cex = 1, size = 1.3)
...
if(labels==T){texts3d(x,y,z+abs(range(z)[1]),adj=adj,text=names,font=1,cex=cex,add=T,top=T,axes=F,xlab='',ylab='',zlab='',
                      legend3d("topright", legend = groups_7, pch = 16, col = colors_7, inset = c(0), cex = 0.65))}

rglwidget()

#~~~~~~~~

# rgl.snapshot("../2018/MDS/kodiak_populations_63_fst.png", fmt = "png")
```
...
rgl.snapshot("../2018/MDS/kodiak_no_outliers_populations_63_fst.png", fmt = "png")
```

### Make legends

```{r legends}
png(filename = "../2018/MDS/legend_groups_7.png", width = 5, height = 5, units = "in", res = 1600)
plot.new()
legend("topright", legend = groups_7, col = colors_7, pch = 16, cex = 1.5)
dev.off()

png(filename = "../2018/MDS/legend_groups_4.png", width = 5, height = 5, units = "in", res = 1600)
plot.new()
legend("topright", legend = groups_7[4:7], col = colors_7[4:7], pch = 16, cex = 1.5)
dev.off()

png(filename = "../2018/MDS/legend_groups_3.png", width = 5, height = 5, units = "in", res = 1600)
plot.new()
legend("topright", legend = groups_7[5:7], col = colors_7[5:7], pch = 16, cex = 1.5)
dev.off()
```
